...
static TAutoConsoleVariable<float> CVarTAAHighSpeedBlendFactor(
	TEXT("r.TemporalAA.HighSpeedBlendFactor"),
	1.0f,
	TEXT("Blend Factor used for pixels with high screen space speed"),
	ECVF_RenderThreadSafe);

static TAutoConsoleVariable<float> CVarTAAMaxSpeed(
	TEXT("r.TemporalAA.MaxSpeed"),
	40.0f,
	TEXT("Max Speed when TAA uses TAAHighSpeedBlendFactor"),
	ECVF_RenderThreadSafe);
// FB Bulgakov End
