...
public:
	...
	FShaderParameter MiscParameters; // FB Bulgakov - Ghosting fix
	...
	void Bind(const FShader::CompiledShaderInitializerType& Initializer)
	{
		...
		MiscParameters.Bind(ParameterMap, TEXT("MiscParameters")); // FB Bulgakov - Ghosting fix
	}
	...
	void Serialize(FArchive& Ar)
	{
		...
		Ar << MiscParameters; // FB Bulgakov - Ghosting fix
	}
		...
		const FIntPoint& SrcSize)
	{
		...
		{
			const FVector4& MiscParametersValue = PassParameters.MiscParameters;
			SetShaderValue(RHICmdList, ShaderRHI, MiscParameters, MiscParametersValue);
		}
		// FB Bulgakov End
